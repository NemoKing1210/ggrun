...
export const dashboard: Widen<typeof CoreEn.dashboard> = {
  ...
  runOver: "Ваш забег окончен",
  runOverHint: "Бросков в этом сезоне больше не будет — доска позади.",
  finishedOn: "Дошли до финиша {date}",
...
export const errors: Widen<typeof CoreEn.errors> = {
  ...
  ieeEventNotFound: "Челлендж не найден",
  ieeEventNotOpen: "Этот челлендж уже закрыт",
  ieeProofRequired: "Приложите пруф (минимум 5 символов)",
  ieeItemNotFound: "Предмет не найден",
  ieeEffectNotFound: "Эффект не найден",
  ieeEffectNotActive: "Этот эффект уже закончился",
  ieeItemAlreadyUsed: "Этот предмет уже использован",
  ieeItemNotUsable: "Этот предмет работает сам по себе — активировать нечего",
  ieeItemWrongWindow: "Сейчас этот предмет применить нельзя",
  ieeTargetingDisabled: "В этом сезоне применять предметы на других игроков нельзя",
  ieeTargetProtected: "Этот игрок ещё под защитой новичка",
  ieeTargetAlreadyAffected: "На этом игроке уже висит этот эффект",
  ieeEventKeyExists: "Шаблон события с ключом «{key}» уже существует",
  ieeInvalidKey: "Ключ может содержать только строчные буквы, цифры и подчёркивания",
  ieeUnknownItemKey: "Неизвестный ключ предмета — его нет в каталоге",
  ieeUnknownEffectKey: "Неизвестный ключ эффекта — его нет в каталоге",
  ieeTargetRequired: "Выберите игрока-цель",
  ieeTargetSelfNotAllowed: "Этот предмет нельзя применить на себя",
  ieeTargetNotActive: "Этот игрок больше не активен в сезоне",
  ...
  gamePlayerNotActive: "Этот участник уже не проходит сезон",
